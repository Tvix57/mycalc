...
TEST(calc_math_construct_test, copy_contruct_eq_1) {
  QString test25 = "34.4+34/3";
  back *test_b = new back(test25);
  back test_copy = *test_b;
  test_b->~back();
...
TEST(calc_math_construct_test, copy_contruct_eq_2) {
  QString test25 = "123%sqrt(100)";
  back *test_b = new back(test25);
  back test_copy = *test_b;
  test_b->~back();
...
TEST(calc_math_construct_test, copy_contruct_eq_3) {
  QString test25 = "ln(256-3)";
  back *test_b = new back(test25);
  back test_copy = *test_b;
  test_b->~back();
...
TEST(calc_math_construct_test, copy_contruct_eq_4) {
  QString test25 = "log(123.345)";
  back *test_b = new back(test25);
  back test_copy = *test_b;
  test_b->~back();
...
TEST(calc_math_construct_test, copy_contruct_eq_5) {
  QString test25 = "(-sin(13.4+atan(7)*56.4-17/4)*(cos(tan(2^4)))";
  back *test_b = new back(test25);
  back test_copy = *test_b;
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct1) {
  QString test25 = "34.4+34/3";
  back *test_b = new back(test25);
  back test_copy(std::move(*test_b));
  test_b->~back();
  double r25 = test_copy.calculate();
  double cp25 = 45.7333333333333333;
  ASSERT_NEAR(r25, cp25, EPS);
...
TEST(calc_math_construct_test, move_contruct2) {
  QString test25 = "123%sqrt(100)";
  back *test_b = new back(test25);
  back test_copy(std::move(*test_b));
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct3) {
  QString test25 = "ln(256-3)";
  back *test_b = new back(test25);
  back test_copy(std::move(*test_b));
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct4) {
  QString test25 = "log(123.345)";
  back *test_b = new back(test25);
  back test_copy(std::move(*test_b));
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct5) {
  QString test25 = "(-sin(13.4+atan(7)*56.4-17/4)*(cos(tan(2^4)))";
  back *test_b = new back(test25);
  back test_copy(std::move(*test_b));
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct_eq_1) {
  QString test25 = "34.4+34/3";
  back *test_b = new back(test25);
  back test_copy = std::move(*test_b);
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct_eq_2) {
  QString test25 = "123%sqrt(100)";
  back *test_b = new back(test25);
  back test_copy = std::move(*test_b);
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct_eq_3) {
  QString test25 = "ln(256-3)";
  back *test_b = new back(test25);
  back test_copy = std::move(*test_b);
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct_eq_4) {
  QString test25 = "log(123.345)";
  back *test_b = new back(test25);
  back test_copy = std::move(*test_b);
  test_b->~back();
...
TEST(calc_math_construct_test, move_contruct_eq_5) {
  QString test25 = "(-sin(13.4+atan(7)*56.4-17/4)*(cos(tan(2^4)))";
  back *test_b = new back(test25);
  back test_copy = std::move(*test_b);
  test_b->~back();
